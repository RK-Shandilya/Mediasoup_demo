...
import type { ProducerStat } from 'mediasoup/node/src/ProducerTypes';
import type { MediaKind, RtpCapabilities, RtpEncodingParameters, RtpParameters } from 'mediasoup/node/src/rtpParametersTypes';
import type { RtpStreamSendStats } from 'mediasoup/node/src/rtpStreamStatsTypes';
...
export interface Consumer<ConsumerAppData extends AppData = AppData> extends EnhancedEventEmitter<ConsumerEvents> {
    /**
     * Consumer id.
     */
    get id(): string;
...
//# sourceMappingURL=ConsumerTypes.d.ts.map