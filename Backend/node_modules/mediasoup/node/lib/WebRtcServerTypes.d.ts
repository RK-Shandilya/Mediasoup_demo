...
import type { TransportListenInfo } from 'mediasoup/node/src/TransportTypes';
import type { WebRtcTransport } from 'mediasoup/node/src/WebRtcTransportTypes';
...
export type WebRtcServerObserver = EnhancedEventEmitter<WebRtcServerObserverEvents>;
export type WebRtcServerObserverEvents = {
    close: [];
    webrtctransporthandled: [WebRtcTransport];
    webrtctransportunhandled: [WebRtcTransport];
};
export interface WebRtcServer<WebRtcServerAppData extends AppData = AppData> extends EnhancedEventEmitter<WebRtcServerEvents> {
    /**
     * WebRtcServer id.
     */
    get id(): string;
...
//# sourceMappingURL=WebRtcServerTypes.d.ts.map